...
const CHIP_OPTIONS = ['Mobile', 'Desktop', 'Offline', 'Analytics', 'Realtime'];
...
export function ControlsShowcase() {
  ...
  const [selectedChips, setSelectedChips] = useState<string[]>(['Mobile', 'Analytics']);
