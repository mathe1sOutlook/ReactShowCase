...
const CATEGORIES: ScreenCategory[] = [
  ...
  },
  {
    key: 'Canvas',
    title: 'Canvas 2D',
    subtitle: 'Drawing, brushes, colors & strokes',
    icon: '\u{1F3A8}',
  ...
  },
  {
    key: 'ThreeD',
    title: '3D Transforms',
    subtitle: 'Perspective, rotation & drag interaction',
    icon: '\u{1F4A0}',
    color: Colors.accent,
    demoCount: 4,
  },
  {
    key: 'Charts',
    title: 'Charts & Data',
    subtitle: 'Bar charts, line charts & visualization',
    icon: '\u{1F4CA}',
  ...
  },
  {
    key: 'Platform',
    title: 'Platform',
    subtitle: 'Hardware, sensors & capabilities',
    icon: '\u{1F4F1}',
