...
const ANDROID_PALETTES: AndroidPalette[] = [
  {
    name: 'Ocean Bloom',
    primary: '#7cdfff',
    secondary: '#ffb3de',
...
const ANDROID_SHORTCUTS: AndroidShortcut[] = [
  {id: 'capture', label: 'Quick Capture', route: 'cfdandroid://media', tone: Colors.primary},
  {id: 'scan', label: 'Scan QR', route: 'cfdandroid://files', tone: Colors.warning},
  {id: 'sync', label: 'Resume Sync', route: 'cfdandroid://platform', tone: Colors.success},
];
const ANDROID_CHANNELS: AndroidChannel[] = [
  {id: 'deployments', label: 'Deployments', importance: 'Default', tone: Colors.primary},
...
const ANDROID_SWIPE_ITEMS: AndroidSwipeItem[] = [
  {
    id: 'build-queue',
    title: 'Build queue',
...
const ANDROID_FAB_ACTIONS = ['Compose', 'Capture', 'Sync'] as const;
const ANDROID_BOTTOM_TABS = ['Home', 'Search', 'Files', 'Profile'] as const;
const ANDROID_LAUNCH_STATES = ['Cold start', 'Warm start', 'Resume'] as const;
const ANDROID_SERVICE_TASKS = ['Media sync', 'Location trace', 'Upload queue'] as const;
