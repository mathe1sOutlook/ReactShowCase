...
export function PickersShowcase() {
  ...
  const initialHsl: HslColor = {h: 208, s: 86, l: 42};
      ...
      <DemoCard
        ...
        <View style={styles.panel}>
            ...
            {visibleImages.map(item => {
              ...
              return (
                <Pressable
                  ...
                  <View style={[styles.thumbnailArt, {backgroundColor: `${item.tint}24`}]} />
          ...
          <View style={styles.previewCard}>
            <View style={[styles.previewFrame, {backgroundColor: `${selectedImage.tint}20`}]} />
            <View style={styles.valueCopy}>
