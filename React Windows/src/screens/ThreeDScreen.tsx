...
function TransformationsSection() {
  return (
    <SectionWrapper
      ...
      subtitle="Touch-driven perspective cards with depth and orbit gestures.">
      <Text style={styles.hintText}>Tap and drag to tilt each card in 3D space.</Text>
...
function Software3DSection() {
  ...
  return (
    <SectionWrapper
      title="Software 3D Lab"
      subtitle="SVG fallback renderer with OBJ parsing, lighting presets, textured sphere shading, and a procedural shader-like surface.">
