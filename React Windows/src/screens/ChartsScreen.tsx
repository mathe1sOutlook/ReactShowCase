...
const BAR_DATA = [
  ...
  {label: 'Jun', value: 64, color: '#f97316'},
];
...
const SCATTER_POINTS = [
  ...
  {label: 'Epsilon', x: 78, y: 54, color: '#f97316'},
  {label: 'Zeta', x: 86, y: 82, color: '#ec4899'},
];
...
function ChartsDashboard() {
  ...
  return (
    <SectionWrapper
      ...
      subtitle="Responsive SVG charts with realtime updates, touch inspection, matrix views and finance-style analytics.">
